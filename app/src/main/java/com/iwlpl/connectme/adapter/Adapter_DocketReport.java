...
public class Adapter_DocketReport extends RecyclerView.Adapter<Adapter_DocketReport.MyViewHolder> {

    ArrayList<DataDocket> dataDockets;
    Context context;

    public Adapter_DocketReport(ArrayList<DataDocket> dataDockets, Context context) {
    ...
    @NonNull
    @Override
    public Adapter_DocketReport.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.cv_docket_report,parent,false));

    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_DocketReport.MyViewHolder holder, int position) {
        try {
        holder.no.setText(dataDockets.get(position).getDocketno());
        holder.date.setText(dataDockets.get(position).getDocketdate());
       // holder.sender.setText(dataDockets.get(position).getSenderName());
        ...
        } catch (Exception e) { handleError(e,"Adapter_DocketReport)");}
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        void handleError(Exception e,String loc){
            new ErrorManager(context, "Adapter_DocketReport",
